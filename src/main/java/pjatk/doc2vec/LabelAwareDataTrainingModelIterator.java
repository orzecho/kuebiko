...
public class LabelAwareDataTrainingModelIterator implements LabelAwareSentenceIterator {
    ...
    public LabelAwareDataTrainingModelIterator(DataTrainingModel dataTrainingModel) {
